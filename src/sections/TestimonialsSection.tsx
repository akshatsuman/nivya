...
const testimonials = [
  ...
  {
    quote: "Regular plans, clear details, and a chat that will not give advice when I ask for it.",
    name: "Ananya Rao",
...
export default function TestimonialsSection() {
  ...
  return (
    <section id="testimonials" ref={sectionRef} className="w-full bg-paper-deep section-y">
